...
A lock-in amplifier compares a data signal with a reference signal. It only amplifies the part of the data signal, which has the same frequency and is in phase with the reference signal.
