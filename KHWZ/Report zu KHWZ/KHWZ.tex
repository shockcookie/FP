...
\begin{document}
	...
	\begin{figure}[h]
		...
		\centering
		\caption{\small Logarithmic scaled plot all data points.
	...
	\end{figure}
 	...
 	\centering
 	\caption{\small Logarithmic scaled plot of the background data with the fitted
	...
	\end{figure}
 	...
 	\centering
 	\caption{\small Logarithmic scaled plot of all data with subtracted background curve. Due to the choice of the axis labels, some of the unused data is not visible. Notable are the abnormally big errors.}
 	\label{log_clean}
	\end{figure}
 	...
 	\centering
 	\caption{\small Logarithmic scaled plot of the region of interest and the fitted 
 	curve. Notable are the abnormally big errors.}
