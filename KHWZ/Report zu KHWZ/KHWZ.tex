...
\begin{document}
	...
	\subsection{Interaction between Matter and $\gamma-$Photons}	
 	...
 	The $\gamma$-decay to the $14.4$\,keV state and the and the one with $10\%$ probability can be used to measure the half-life of the named state by using the method of delayed coincidence.\\
\end{document}