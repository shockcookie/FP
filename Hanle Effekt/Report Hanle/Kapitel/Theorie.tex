...
\begin{figure}
	...
	\centering
	\caption[Lorentzkurve]{Lorentzkurve mit sichtbare Intensität in Beobachtungsrichtung $0^\circ$ mit FWHM eingezeichnet.}
	\label{Lorenzbild}
\end{figure}
...
\begin{figure}[ht]
	...
	\centering
	\caption[Zeeman-Effekt]{Aufspaltung der Energieniveaus durch $m_j$ in einem Magnetfeld.}
\end{figure}
